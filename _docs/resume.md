...
Python, Salt, Terragrunt, Terraform, Google Cloud Platform (GCP), Bash, Ansible, Kerberos, LDAP, Prometheus, Grafana, Nagios, Linux, Java, SQL, Git, Jenkins, GitHub Actions, Maven, Hadoop, Hortonworks Data Platform (HDP), Cloudera Data Platform (CDP), Apache httpd, Apache Tomcat, Kanban, Scrum
...
January 2022 to January 2026   
    ...
    - Led infrastructure setup for new European region of SaaS product.   
      - Updated Terraform to support deploying consistently across multiple regions.   
